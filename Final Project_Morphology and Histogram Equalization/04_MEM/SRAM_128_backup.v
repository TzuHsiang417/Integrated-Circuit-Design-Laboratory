...
//      Pipeline:       No
//
//      Creation Date:  2022-12-29 06:51:04Z
//      Version: 	2001Q4V0
//
...
module SRAM_128 (
   ...
   specify
      ...
      $setuphold(posedge CLK &&& re_data_flag, D[8], 1.000, 0.500, NOT_D8);
      $setuphold(posedge CLK &&& re_data_flag, D[9], 1.000, 0.500, NOT_D9);
      $setuphold(posedge CLK &&& re_data_flag, D[10], 1.000, 0.500, NOT_D10);
      $setuphold(posedge CLK &&& re_data_flag, D[11], 1.000, 0.500, NOT_D11);
      $setuphold(posedge CLK &&& re_data_flag, D[12], 1.000, 0.500, NOT_D12);
      $setuphold(posedge CLK &&& re_data_flag, D[13], 1.000, 0.500, NOT_D13);
      $setuphold(posedge CLK &&& re_data_flag, D[14], 1.000, 0.500, NOT_D14);
      $setuphold(posedge CLK &&& re_data_flag, D[15], 1.000, 0.500, NOT_D15);
      $setuphold(posedge CLK &&& re_data_flag, D[16], 1.000, 0.500, NOT_D16);
      $setuphold(posedge CLK &&& re_data_flag, D[17], 1.000, 0.500, NOT_D17);
      $setuphold(posedge CLK &&& re_data_flag, D[18], 1.000, 0.500, NOT_D18);
      $setuphold(posedge CLK &&& re_data_flag, D[19], 1.000, 0.500, NOT_D19);
      $setuphold(posedge CLK &&& re_data_flag, D[20], 1.000, 0.500, NOT_D20);
      $setuphold(posedge CLK &&& re_data_flag, D[21], 1.000, 0.500, NOT_D21);
      $setuphold(posedge CLK &&& re_data_flag, D[22], 1.000, 0.500, NOT_D22);
      $setuphold(posedge CLK &&& re_data_flag, D[23], 1.000, 0.500, NOT_D23);
      $setuphold(posedge CLK &&& re_data_flag, D[24], 1.000, 0.500, NOT_D24);
      $setuphold(posedge CLK &&& re_data_flag, D[25], 1.000, 0.500, NOT_D25);
      $setuphold(posedge CLK &&& re_data_flag, D[26], 1.000, 0.500, NOT_D26);
      $setuphold(posedge CLK &&& re_data_flag, D[27], 1.000, 0.500, NOT_D27);
      $setuphold(posedge CLK &&& re_data_flag, D[28], 1.000, 0.500, NOT_D28);
      $setuphold(posedge CLK &&& re_data_flag, D[29], 1.000, 0.500, NOT_D29);
      $setuphold(posedge CLK &&& re_data_flag, D[30], 1.000, 0.500, NOT_D30);
      $setuphold(posedge CLK &&& re_data_flag, D[31], 1.000, 0.500, NOT_D31);
      $setuphold(posedge CLK &&& re_data_flag, D[32], 1.000, 0.500, NOT_D32);
      $setuphold(posedge CLK &&& re_data_flag, D[33], 1.000, 0.500, NOT_D33);
      $setuphold(posedge CLK &&& re_data_flag, D[34], 1.000, 0.500, NOT_D34);
      $setuphold(posedge CLK &&& re_data_flag, D[35], 1.000, 0.500, NOT_D35);
      $setuphold(posedge CLK &&& re_data_flag, D[36], 1.000, 0.500, NOT_D36);
      $setuphold(posedge CLK &&& re_data_flag, D[37], 1.000, 0.500, NOT_D37);
      $setuphold(posedge CLK &&& re_data_flag, D[38], 1.000, 0.500, NOT_D38);
      $setuphold(posedge CLK &&& re_data_flag, D[39], 1.000, 0.500, NOT_D39);
      $setuphold(posedge CLK &&& re_data_flag, D[40], 1.000, 0.500, NOT_D40);
      $setuphold(posedge CLK &&& re_data_flag, D[41], 1.000, 0.500, NOT_D41);
      $setuphold(posedge CLK &&& re_data_flag, D[42], 1.000, 0.500, NOT_D42);
      $setuphold(posedge CLK &&& re_data_flag, D[43], 1.000, 0.500, NOT_D43);
      $setuphold(posedge CLK &&& re_data_flag, D[44], 1.000, 0.500, NOT_D44);
      $setuphold(posedge CLK &&& re_data_flag, D[45], 1.000, 0.500, NOT_D45);
      $setuphold(posedge CLK &&& re_data_flag, D[46], 1.000, 0.500, NOT_D46);
      $setuphold(posedge CLK &&& re_data_flag, D[47], 1.000, 0.500, NOT_D47);
      $setuphold(posedge CLK &&& re_data_flag, D[48], 1.000, 0.500, NOT_D48);
      $setuphold(posedge CLK &&& re_data_flag, D[49], 1.000, 0.500, NOT_D49);
      $setuphold(posedge CLK &&& re_data_flag, D[50], 1.000, 0.500, NOT_D50);
      $setuphold(posedge CLK &&& re_data_flag, D[51], 1.000, 0.500, NOT_D51);
      $setuphold(posedge CLK &&& re_data_flag, D[52], 1.000, 0.500, NOT_D52);
      $setuphold(posedge CLK &&& re_data_flag, D[53], 1.000, 0.500, NOT_D53);
      $setuphold(posedge CLK &&& re_data_flag, D[54], 1.000, 0.500, NOT_D54);
      $setuphold(posedge CLK &&& re_data_flag, D[55], 1.000, 0.500, NOT_D55);
      $setuphold(posedge CLK &&& re_data_flag, D[56], 1.000, 0.500, NOT_D56);
      $setuphold(posedge CLK &&& re_data_flag, D[57], 1.000, 0.500, NOT_D57);
      $setuphold(posedge CLK &&& re_data_flag, D[58], 1.000, 0.500, NOT_D58);
      $setuphold(posedge CLK &&& re_data_flag, D[59], 1.000, 0.500, NOT_D59);
      $setuphold(posedge CLK &&& re_data_flag, D[60], 1.000, 0.500, NOT_D60);
      $setuphold(posedge CLK &&& re_data_flag, D[61], 1.000, 0.500, NOT_D61);
      $setuphold(posedge CLK &&& re_data_flag, D[62], 1.000, 0.500, NOT_D62);
      $setuphold(posedge CLK &&& re_data_flag, D[63], 1.000, 0.500, NOT_D63);
      $setuphold(posedge CLK &&& re_data_flag, D[64], 1.000, 0.500, NOT_D64);
      $setuphold(posedge CLK &&& re_data_flag, D[65], 1.000, 0.500, NOT_D65);
      $setuphold(posedge CLK &&& re_data_flag, D[66], 1.000, 0.500, NOT_D66);
      $setuphold(posedge CLK &&& re_data_flag, D[67], 1.000, 0.500, NOT_D67);
      $setuphold(posedge CLK &&& re_data_flag, D[68], 1.000, 0.500, NOT_D68);
      $setuphold(posedge CLK &&& re_data_flag, D[69], 1.000, 0.500, NOT_D69);
      $setuphold(posedge CLK &&& re_data_flag, D[70], 1.000, 0.500, NOT_D70);
      $setuphold(posedge CLK &&& re_data_flag, D[71], 1.000, 0.500, NOT_D71);
      $setuphold(posedge CLK &&& re_data_flag, D[72], 1.000, 0.500, NOT_D72);
      $setuphold(posedge CLK &&& re_data_flag, D[73], 1.000, 0.500, NOT_D73);
      $setuphold(posedge CLK &&& re_data_flag, D[74], 1.000, 0.500, NOT_D74);
      $setuphold(posedge CLK &&& re_data_flag, D[75], 1.000, 0.500, NOT_D75);
      $setuphold(posedge CLK &&& re_data_flag, D[76], 1.000, 0.500, NOT_D76);
      $setuphold(posedge CLK &&& re_data_flag, D[77], 1.000, 0.500, NOT_D77);
      $setuphold(posedge CLK &&& re_data_flag, D[78], 1.000, 0.500, NOT_D78);
      $setuphold(posedge CLK &&& re_data_flag, D[79], 1.000, 0.500, NOT_D79);
      $setuphold(posedge CLK &&& re_data_flag, D[80], 1.000, 0.500, NOT_D80);
      $setuphold(posedge CLK &&& re_data_flag, D[81], 1.000, 0.500, NOT_D81);
      $setuphold(posedge CLK &&& re_data_flag, D[82], 1.000, 0.500, NOT_D82);
      $setuphold(posedge CLK &&& re_data_flag, D[83], 1.000, 0.500, NOT_D83);
      $setuphold(posedge CLK &&& re_data_flag, D[84], 1.000, 0.500, NOT_D84);
      $setuphold(posedge CLK &&& re_data_flag, D[85], 1.000, 0.500, NOT_D85);
      $setuphold(posedge CLK &&& re_data_flag, D[86], 1.000, 0.500, NOT_D86);
      $setuphold(posedge CLK &&& re_data_flag, D[87], 1.000, 0.500, NOT_D87);
      $setuphold(posedge CLK &&& re_data_flag, D[88], 1.000, 0.500, NOT_D88);
      $setuphold(posedge CLK &&& re_data_flag, D[89], 1.000, 0.500, NOT_D89);
      $setuphold(posedge CLK &&& re_data_flag, D[90], 1.000, 0.500, NOT_D90);
      $setuphold(posedge CLK &&& re_data_flag, D[91], 1.000, 0.500, NOT_D91);
      $setuphold(posedge CLK &&& re_data_flag, D[92], 1.000, 0.500, NOT_D92);
      $setuphold(posedge CLK &&& re_data_flag, D[93], 1.000, 0.500, NOT_D93);
      $setuphold(posedge CLK &&& re_data_flag, D[94], 1.000, 0.500, NOT_D94);
      $setuphold(posedge CLK &&& re_data_flag, D[95], 1.000, 0.500, NOT_D95);
      $setuphold(posedge CLK &&& re_data_flag, D[96], 1.000, 0.500, NOT_D96);
      $setuphold(posedge CLK &&& re_data_flag, D[97], 1.000, 0.500, NOT_D97);
      $setuphold(posedge CLK &&& re_data_flag, D[98], 1.000, 0.500, NOT_D98);
      $setuphold(posedge CLK &&& re_data_flag, D[99], 1.000, 0.500, NOT_D99);
      $setuphold(posedge CLK &&& re_data_flag, D[100], 1.000, 0.500, NOT_D100);
      $setuphold(posedge CLK &&& re_data_flag, D[101], 1.000, 0.500, NOT_D101);
      $setuphold(posedge CLK &&& re_data_flag, D[102], 1.000, 0.500, NOT_D102);
      $setuphold(posedge CLK &&& re_data_flag, D[103], 1.000, 0.500, NOT_D103);
      $setuphold(posedge CLK &&& re_data_flag, D[104], 1.000, 0.500, NOT_D104);
      $setuphold(posedge CLK &&& re_data_flag, D[105], 1.000, 0.500, NOT_D105);
      $setuphold(posedge CLK &&& re_data_flag, D[106], 1.000, 0.500, NOT_D106);
      $setuphold(posedge CLK &&& re_data_flag, D[107], 1.000, 0.500, NOT_D107);
      $setuphold(posedge CLK &&& re_data_flag, D[108], 1.000, 0.500, NOT_D108);
      $setuphold(posedge CLK &&& re_data_flag, D[109], 1.000, 0.500, NOT_D109);
      $setuphold(posedge CLK &&& re_data_flag, D[110], 1.000, 0.500, NOT_D110);
      $setuphold(posedge CLK &&& re_data_flag, D[111], 1.000, 0.500, NOT_D111);
      $setuphold(posedge CLK &&& re_data_flag, D[112], 1.000, 0.500, NOT_D112);
      $setuphold(posedge CLK &&& re_data_flag, D[113], 1.000, 0.500, NOT_D113);
      $setuphold(posedge CLK &&& re_data_flag, D[114], 1.000, 0.500, NOT_D114);
      $setuphold(posedge CLK &&& re_data_flag, D[115], 1.000, 0.500, NOT_D115);
      $setuphold(posedge CLK &&& re_data_flag, D[116], 1.000, 0.500, NOT_D116);
      $setuphold(posedge CLK &&& re_data_flag, D[117], 1.000, 0.500, NOT_D117);
      $setuphold(posedge CLK &&& re_data_flag, D[118], 1.000, 0.500, NOT_D118);
      $setuphold(posedge CLK &&& re_data_flag, D[119], 1.000, 0.500, NOT_D119);
      $setuphold(posedge CLK &&& re_data_flag, D[120], 1.000, 0.500, NOT_D120);
      $setuphold(posedge CLK &&& re_data_flag, D[121], 1.000, 0.500, NOT_D121);
      $setuphold(posedge CLK &&& re_data_flag, D[122], 1.000, 0.500, NOT_D122);
      $setuphold(posedge CLK &&& re_data_flag, D[123], 1.000, 0.500, NOT_D123);
      $setuphold(posedge CLK &&& re_data_flag, D[124], 1.000, 0.500, NOT_D124);
      $setuphold(posedge CLK &&& re_data_flag, D[125], 1.000, 0.500, NOT_D125);
      $setuphold(posedge CLK &&& re_data_flag, D[126], 1.000, 0.500, NOT_D126);
      $setuphold(posedge CLK &&& re_data_flag, D[127], 1.000, 0.500, NOT_D127);
      ...
      (OEN => Q[34])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[35])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[36])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[37])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[38])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[39])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[40])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[41])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[42])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[43])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[44])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[45])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[46])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[47])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[48])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[49])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[50])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[51])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[52])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[53])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[54])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[55])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[56])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[57])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[58])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[59])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[60])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[61])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[62])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[63])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[64])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[65])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[66])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[67])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[68])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[69])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[70])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[71])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[72])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[73])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[74])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[75])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[76])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[77])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[78])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[79])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[80])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[81])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[82])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[83])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[84])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[85])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[86])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[87])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[88])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[89])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[90])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[91])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[92])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[93])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[94])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[95])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[96])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[97])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[98])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[99])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[100])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[101])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[102])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[103])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[104])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[105])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[106])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[107])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[108])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[109])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[110])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[111])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[112])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[113])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[114])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[115])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[116])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[117])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[118])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[119])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[120])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[121])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[122])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[123])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[124])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[125])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[126])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
      (OEN => Q[127])=(1.000, 1.000, 1.000, 1.000, 1.000, 1.000);
   endspecify
