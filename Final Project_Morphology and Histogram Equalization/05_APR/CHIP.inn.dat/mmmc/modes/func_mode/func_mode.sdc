...
#  OS:                Linux x86_64(Host ID ee14)
#  Generated on:      Sun Jan  1 02:21:07 2023
#  Design:            CHIP
#  Command:           routeDesign -globalDetail
###############################################################
current_design CHIP
create_clock [get_ports {clk2}]  -name clk2 -period 15.000000 -waveform {0.000000 7.500000}
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[1]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[6]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[2]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[7]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[3]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[8]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[4]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[9]}]
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[0]}]
...
set_input_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {pic_data[5]}]
...
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[1]}]
...
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[8]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[6]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[28]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[4]}]
...
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[2]}]
...
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[0]}]
...
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[9]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[7]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[29]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[5]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[27]}]
set_output_delay -add_delay 10 -clock [get_clocks {clk}] [get_ports {out_data[3]}]
